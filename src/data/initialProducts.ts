...
export const CATEGORY_DEFAULT_IMAGES: Record<ProductCategory, string> = {
  ...
  'Office Furniture': 'https://images.unsplash.com/photo-1580481077190-73614561e9f9?auto=format&fit=crop&w=600&q=80',
  'Audio': 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=600&q=80',
  'Accessories': 'https://images.unsplash.com/photo-1625842268584-8f3296236761?auto=format&fit=crop&w=600&q=80',
};

export function getDefaultProductImage(name: string, category: ProductCategory): string {
  ...
  if (lowerName.includes('monitor') || lowerName.includes('screen') || lowerName.includes('display')) {
  ...
  if (lowerName.includes('hub') || lowerName.includes('adapter') || lowerName.includes('port')) {
  ...
  return CATEGORY_DEFAULT_IMAGES[category] || CATEGORY_DEFAULT_IMAGES['Electronics'];
}
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 349.00,
    imageUrl: 'https://images.unsplash.com/photo-1580481077190-73614561e9f9?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: 'prod-3',
